...
class TopNavigation:
    ...
    def __init__(self):
        self.parent_element_top_navigation = (AppiumBy.ID, "ru.kinopoisk:id/top_navigation")
        self.my_movies_button = (AppiumBy.XPATH, "//android.widget.TextView[@text='Моё кино']")
        self.sport_button = (AppiumBy.XPATH, "//android.widget.TextView[@text='Спорт']")
        self.channels_button = (AppiumBy.XPATH, "//android.widget.TextView[@text='Каналы']")
        self.store_button = (AppiumBy.XPATH, "//android.widget.TextView[@text='Магазин']")
    ...
    def tap_my_movies_button(self):
        s(self.my_movies_button).should(EC.by_and(be.clickable, have.text("Моё кино"))).click()
        return self
    ...
    def tap_channels_button(self):
        s(self.channels_button).should(EC.by_and(be.clickable, have.text("Каналы"))).click()
        return self


    @step("Нажимаем на кнопку 'Магазин'")
    def tap_store_button(self):
        s(self.store_button).should(EC.by_and(be.clickable, have.text("Магазин"))).click()
        return self
