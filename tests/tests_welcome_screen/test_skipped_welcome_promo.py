...
class TestSkippedWelcomePromo:
    ...
    def test_skipped_welcome_promo_and_yandex_plus_by_tapping(self):
        kinopoisk_app.welcome_screen.check_title_is_present().tap_button_next().check_title_is_present().tap_button_next().tap_yandex_plus_not_now_button().tap_allow_notifications_button()
    ...
    def test_skipped_welcome_promo_and_yandex_plus_by_swipe(self):
        ...
        kinopoisk_app.welcome_screen.check_title_is_present()
        kinopoisk_app.mobile_actions.swipe_left()
        kinopoisk_app.welcome_screen.tap_yandex_plus_not_now_button().tap_allow_notifications_button()
